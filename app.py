...
c = conn.cursor()
c.execute('CREATE TABLE IF NOT EXISTS students (name TEXT NOT NULL, age INTEGER NOT NULL, email TEXT NOT NULL, password TEXT NOT NULL)')
c.execute('CREATE TABLE IF NOT EXISTS DONORDETAILS(name TEXT NOT NULL,bloodgroup TEXT NOT NULL,email TEXT NOT NULL)')
c.execute('CREATE TABLE IF NOT EXISTS BLOODAVAIL(BLOODGROUP TEXT NOT NULL,UNIT INTEGER NOT NULL)')
c.execute('CREATE TABLE IF NOT EXISTS NEED(HOSPITALNAME TEXT NOT NULL,HOSPITALID INTEGER NOT NULL,BLOODGROUP TEXT NOT NULL,UNIT INTEGER NOT NULL,STATUS TEXT NOT NULL)')
c.execute('CREATE TABLE IF NOT EXISTS ADMIN(ADMINNAME TEXT NOT NULL,ADMIN_ID INTEGER NOT NULL,ADMIN_EMAIL TEXT NOT NULL)')
...
def donor():
    ...
    if request.method == 'POST':
        ...
        return render_template('donor.html',text = text)
    else:
